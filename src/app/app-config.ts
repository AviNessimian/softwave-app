...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
            authority: "https://" + environment.tenant + ".b2clogin.com/" + environment.tenant + ".onmicrosoft.com/B2C_1_SignUpIn"
        },
        resetPassword: {
            authority: "https://" + environment.tenant + ".b2clogin.com/" + environment.tenant + ".onmicrosoft.com/B2C_1_PasswordReset"
        }
    }
}
// #endregion
...
export const apiConfig: { b2cScopes: string[], webApi: string } = {
    b2cScopes: ["https://" + environment.tenant + ".onmicrosoft.com/api/softwave.read"],
